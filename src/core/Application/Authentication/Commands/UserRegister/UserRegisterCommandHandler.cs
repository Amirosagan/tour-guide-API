...
public class UserRegisterCommandHandler
    : IRequestHandler<UserRegisterCommand, ErrorOr<UserRegisterCommandResponse>>
{
    ...
    public async Task<ErrorOr<UserRegisterCommandResponse>> Handle(
    ...
    )
    {
        ...
        var phoneNumberExist = await _normalUserManager.Users.FirstOrDefaultAsync(x =>
