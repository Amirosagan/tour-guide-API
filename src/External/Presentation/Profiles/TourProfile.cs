...
public class TourProfile : Profile
{
    ...
    private void GetTourProfile()
    {
        ...
        CreateMap<Session, SessionResponseDto>()
            .ForCtorParam(nameof(SessionResponseDto.StartDate), opt => opt.MapFrom(src => src.StartDate))
            .ForCtorParam(nameof(SessionResponseDto.EndDate), opt => opt.MapFrom(src => src.EndDate))
            .ForCtorParam(nameof(SessionResponseDto.CurrentCapacity), opt => opt.MapFrom(src => src.CurrentCapacity));
        
        CreateMap<TourCategory,CreateTourCategoryResponseDto>()
            .ForCtorParam(nameof(CreateTourCategoryResponseDto.Name), opt => opt.MapFrom(src => src.Name));
        ...
        CreateMap<Tour, GetTourResponseDto>()
            ...
            .ForCtorParam(nameof(GetTourResponseDto.Description), opt => opt.MapFrom(src => src.Description))
            .ForCtorParam(nameof(GetTourResponseDto.Price), opt => opt.MapFrom(src => src.Price))
            .ForCtorParam(nameof(GetTourResponseDto.Location), opt => opt.MapFrom(src => src.Location))
            .ForCtorParam(nameof(GetTourResponseDto.GoogleMapsLocation), opt => opt.MapFrom(src => src.GoogleMapsLocation))
            .ForCtorParam(nameof(GetTourResponseDto.MaxCapacity), opt => opt.MapFrom(src => src.MaxCapacity))
            .ForCtorParam(
                nameof(GetTourResponseDto.Images),
                opt => opt.MapFrom(src => src.Images)
            )
            .ForCtorParam(nameof(GetTourResponseDto.Sessions), opt => opt.MapFrom(src => src.Sessions))
            .ForCtorParam(nameof(GetTourResponseDto.TourCategories), opt => opt.MapFrom(src => src.Categories));
    }
}
