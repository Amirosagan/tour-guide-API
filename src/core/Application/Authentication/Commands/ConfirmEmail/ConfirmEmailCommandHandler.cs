...
public class ConfirmEmailCommandHandler : IRequestHandler<ConfirmEmailCommand, ErrorOr<ConfirmEmailCommandResponse>>
{
    ...
    public ConfirmEmailCommandHandler(UserManager<NormalUser> normalUserManager, ILogger<ConfirmEmailCommandHandler> logger, IOtpGenerator otpGenerator, IUserRepository userRepository)
    {
