...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250206184521_FIxSchemeaToDateonly")]
    partial class FIxSchemeaToDateonly
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.TourCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TourTourCategory", b =>
                {
                    ...
                    b.ToTable("TourTourCategory");
                });

            modelBuilder.Entity("Domain.Identity.NormalUser", b =>
                {
            ...
            modelBuilder.Entity("Domain.Identity.TourGuide", b =>
                {
                    b.HasBaseType("Domain.Identity.User");
            ...
            modelBuilder.Entity("TourTourCategory", b =>
                {
                    b.HasOne("Domain.Entities.TourCategory", null)
                        .WithMany()
