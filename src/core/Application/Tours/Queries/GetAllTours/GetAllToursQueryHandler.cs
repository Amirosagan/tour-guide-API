...
public class GetAllToursQueryHandler
    : IRequestHandler<GetAllToursQuery, ErrorOr<GetAllToursQueryResponse>>
{
    ...
    public async Task<ErrorOr<GetAllToursQueryResponse>> Handle(
    ...
    )
    {
        ...
        if (request.SearchTerm != null)
        {
            tours = tours.Where(t =>
                ...
                || t.Location.Contains(request.SearchTerm)
            );
        }
